...
class P2pSignalingRepository {
  P2pSignalingRepository({required final String wsUrl}) : _host = wsUrl;
  ...
  bool muteMic() {
    ...
    final bool isMute = enabled;
    return isMute;
  }

  void invite(
      String selfId, String peerId, String media, bool useScreen) async {
    ...
    _createOffer(selfId, session, media);
    onCallStateChange?.call(session, CallState.CallStateNew);
  }

  void bye(String selfId, String sessionId) {
    _send('bye', {
      ...
      case 'offer':
        {
          ...
          await _createAnswer(selfId, newSession, media);
  ...
  Future<void> _createOffer(
      String selfId, Session session, String media) async {
    try {
